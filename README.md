...
Check out my SQL queries here: [project_sql folder](/SQL_Project_Data/project_sql/)
# Background 
...
- **SQLPostgre**: As the database management system, PostgreSQL allowed me to store, query, and manipulate the job posting data.
